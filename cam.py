...
class Ui_WEBCAM(object):
    def setupUi(self, WEBCAM):
        ...
        self.CorrectPatternHexa.setGeometry(QtCore.QRect(10, 240, 191, 22))
        self.CorrectPatternHexa.setObjectName(_fromUtf8("CorrectPatternHexa"))
        self.CorrectBadPixels = QtGui.QCheckBox(self.centralwidget)
        self.CorrectBadPixels.setGeometry(QtCore.QRect(10, 260, 181, 22))
        self.CorrectBadPixels.setObjectName(_fromUtf8("CorrectBadPixels"))
    ...
    def retranslateUi(self, WEBCAM):
        ...
        self.CorrectBadPixels.setText(_translate("WEBCAM", "Correción Pixeles Muertos", None))
